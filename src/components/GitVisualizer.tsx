    ...
    return (
        <div className="bg-gray-900/50 p-6 rounded-xl border border-gray-700 mb-8 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative">
                {/* Arrow connectors */}
                <div className="hidden md:block absolute top-1/2 left-1/3 -translate-y-1/2 translate-x-[-50%] z-0">
                    <ArrowRight className="text-gray-600 w-8 h-8" />
                </div>
                <div className="hidden md:block absolute top-1/2 right-1/3 -translate-y-1/2 translate-x-[50%] z-0">
                    <ArrowRight className="text-gray-600 w-8 h-8" />
                </div>
